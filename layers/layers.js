...
lyr_KeteranganJalan_3.set('fieldAliases', {'id': 'id', 'Nama': 'Nama', 'Jenis': 'Fungsi', 'Material': 'Material', 'Foto': 'Foto', 'Panjang': 'Panjang', });
lyr_Kelurahan_2.set('fieldImages', {'NAMOBJ': 'TextEdit', 'LUASWH': 'TextEdit', 'WADMKC': 'TextEdit', 'WADMKK': 'TextEdit', });
lyr_KeteranganJalan_3.set('fieldImages', {'id': 'TextEdit', 'Nama': 'TextEdit', 'Jenis': 'TextEdit', 'Material': 'TextEdit', 'Foto': 'ExternalResource', 'Panjang': '', });
...
lyr_KeteranganJalan_3.set('fieldLabels', {'id': 'hidden field', 'Nama': 'inline label - always visible', 'Jenis': 'inline label - always visible', 'Material': 'inline label - always visible', 'Foto': 'inline label - always visible', 'Panjang': 'inline label - always visible', });
